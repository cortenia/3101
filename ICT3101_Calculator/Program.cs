...
namespace ICT3101_Calculator
{
    class Program
    {
        ...
        {
            bool endApp = false;
            Calculator _calculator = new Calculator(); // Display title as the C# console calculator app.
            ...
            while (!endApp)
            {
                ...
                Console.WriteLine("\tc-Basic Model Current Failure Intensity");
                Console.WriteLine("\te-Basic Model Expected Failure Intensity");
                Console.WriteLine("\tl-Log Model Current Failure Intensity");
                Console.WriteLine("\ti-SSI");
